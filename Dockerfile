...
ARG NEXT_PUBLIC_MONERO_APPLICATION_RECIPIENT
ARG NEXT_PUBLIC_FIRO_APPLICATION_RECIPIENT
ARG NEXT_PUBLIC_PRIVACY_GUIDES_APPLICATION_RECIPIENT
ARG NEXT_PUBLIC_GENERAL_APPLICATION_RECIPIENT
ARG NEXT_PUBLIC_ATTESTATION_PUBLIC_KEY_HEX
...
ENV STRAPI_CDN_HOST=$STRAPI_CDN_HOST
